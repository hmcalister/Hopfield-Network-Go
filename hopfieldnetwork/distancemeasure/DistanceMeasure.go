...
func GetManhattanDistanceWithInversion(manager statemanager.StateManager) DistanceMeasure {
	return func(a *mat.VecDense, b *mat.VecDense) float64 {
		vectorDifference := mat.NewVecDense(a.Len(), nil)
...
func GetEuclideanDistanceWithInversion(manager statemanager.StateManager) DistanceMeasure {
	return func(a *mat.VecDense, b *mat.VecDense) float64 {
		vectorDifference := mat.NewVecDense(a.Len(), nil)
